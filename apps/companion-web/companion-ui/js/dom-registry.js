export function createDomRegistry(document) {
  ...
  voice: {
    capture: document.querySelector('[data-hook="voice-capture"]'),
    record: document.querySelector('[data-hook="voice-record"]'),
    call: document.querySelector('[data-hook="voice-call"]'),
    waveform: document.querySelector('[data-hook="voice-waveform"]'),
    duration: document.querySelector('[data-hook="voice-duration"]'),
    status: document.querySelector('[data-hook="voice-status"]'),
    preview: document.querySelector('[data-hook="voice-preview"]'),
    cancel: document.querySelector('[data-hook="voice-cancel"]'),
    confirm: document.querySelector('[data-hook="voice-confirm"]'),
  },
  action: {
  ...
  privacy: {
    ...
    voiceEnabled: document.querySelector('[data-hook="voice-enabled"]'),
    voiceAutoPlay: document.querySelector('[data-hook="voice-auto-play"]'),
    ttsBaseUrl: document.querySelector('[data-hook="tts-base-url"]'),
    ttsApiKey: document.querySelector('[data-hook="tts-api-key"]'),
    ttsKeyState: document.querySelector('[data-hook="tts-key-state"]'),
    ttsModel: document.querySelector('[data-hook="tts-model"]'),
    voiceId: document.querySelector('[data-hook="voice-id"]'),
    voiceRate: document.querySelector('[data-hook="voice-rate"]'),
    voiceVolume: document.querySelector('[data-hook="voice-volume"]'),
    voiceProviderSummary: document.querySelector('[data-hook="voice-provider-summary"]'),
    voiceTest: document.querySelector('[data-hook="voice-test"]'),
    voiceTestStatus: document.querySelector('[data-hook="voice-test-status"]'),
  },
  productization: {
    body: document.body,
