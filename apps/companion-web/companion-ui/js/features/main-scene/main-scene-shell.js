  ...
  <section class="companion-status-panel" aria-label="叶筝此刻的状态">
    ...
    <div class="companion-status-content">
      <article class="companion-status-item">
        <span class="status-orb status-orb-heart" aria-hidden="true"><img src="assets/icons/heartbeat.svg" alt=""></span>
        <span class="status-copy"><strong>心跳平稳</strong><small>72 次/分</small></span>
      </article>
      <article class="companion-status-item">
        <span class="status-orb status-orb-rain" aria-hidden="true"><img src="assets/icons/rain.svg" alt=""></span>
        <span class="status-copy"><strong>正在看雨</strong><small>窗边 · 雨声轻轻</small></span>
      </article>
      <article class="companion-status-item">
        <span class="status-orb status-orb-moon" aria-hidden="true"><img src="assets/icons/quiet-moon.svg" alt=""></span>
